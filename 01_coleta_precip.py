...
postos_precip = {
    ...
    *'Uniao_da_Vitoria_Hid':['26145104', '2651059', '-26.22772', '-51.08059', '749'],
    ...
    'Porto_Carriel':['2452051'],
    'Fazendinha':['2549017'],
    'Quitandinha':['2549061'],
    'Guajuvira':['2549093'],
    'Prudentopolis':['2550000'],
    'Colonia_Vitoria':['2551008'],
    'Santa_Clara':['2551059'],
    'Fundao':['2551060'],
    'Fazenda_Aurora':['25485173'],
    'Guarapuavinha':['23365141'],
    'Marquinho':['2552008'],
    'Salto_Santiago_Chopinzinho':['2552030'],
    'Vau_dos_Ribeiros':['25385201'],
    'PCH_Cavernoso_II':['25495221'],
    'Luiz_Alves':['2648002'],
    'Timbo_Novo':['2649004'],
    'Corupa':['2649013'],
    'Doutor_Pedrinho':['2649017'],
    'Barra_do_Prata':['2649058'],
    'Primeiro_Salto_Cubatao':['2649060'],
    'Barragem_Norte':['2649061'],
    'Campina_da_Alegria':['2651001'],
    'Chopim':['2652023'],
    'Sao_Lourenco_Oeste':['2652031'],
    'Dionisio_Cerqueira':['2653002'],
    'Ponte_do_Sargento':['2653004'],
    'Sao_Jose_Cedro':['2653005']
     }

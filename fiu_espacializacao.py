...
grade = gpd.read_file('../Teste/grade_fiu_2.gpkg')
grade
...
for i,pi in enumerate(grade.index):
    print('Iniciando ponto {}/{} da grade da bacia'.format(i+1,L))
...
PME.rename('chuva_mm').round(2).to_csv('../dados/pme/pme_fiu_horario.csv',

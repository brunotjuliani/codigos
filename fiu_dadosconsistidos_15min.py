...
dados = pd.read_csv('../dados/fiu/' + posto_nome + 'FB.csv',
                    index_col = 0, sep = ';')
...
dicionario_erros = json.load(open('../dados/fiu/erros_grosseiros_fiu.txt'))
...
#                 float_format = '%.3f')
df_15min.to_csv('../dados/fiu/'+posto_nome+'FC.csv',
                date_format='%Y-%m-%dT%H:%M:%SZ', sep = ";",
                float_format = '%.3f')
